    ...
    <div style={styles.app}>
      <div style={styles.topbar}>
        ...
        <button
          ...
          onClick={() => alert("PDF download requires the leasePdf.js base64 file. Please run the full app locally or on Railway.")}
        >
          ↓ Download PDF
        </button>
      </div>
      ...
      <div style={styles.main}>
        ...
        <button style={styles.btnDlFull} onClick={() => alert("PDF download requires the leasePdf.js base64 file. Run the full app locally or on Railway.")}>
          ↓ Download filled lease PDF
        </button>
